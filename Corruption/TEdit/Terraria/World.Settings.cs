...
namespace Corruption.TEdit //TEditXNA.Terraria
{
    internal partial class World
    {
        ...
        private static readonly Dictionary<string, XNA.Color> _globalColors = new();
        private static readonly Dictionary<string, int> _npcIds = new();
        private static readonly Dictionary<int, int> _npcFrames = new();
        private static readonly Dictionary<byte, string> _prefix = new();
        //private static readonly Dictionary<Key, string> _shortcuts = new Dictionary<Key, string>();
        private static readonly Dictionary<int, ItemProperty> _itemLookup = new();
        private static readonly Dictionary<int, string> _tallynames = new();
        private static readonly Dictionary<string, string> _frameNames = new();
        private static readonly Dictionary<int, string> _armorHeadNames = new();
        private static readonly Dictionary<int, string> _armorBodyNames = new();
        private static readonly Dictionary<int, string> _armorLegsNames = new();
        private static readonly Dictionary<int, string> _rackable = new();

        private static readonly ObservableCollection<ItemProperty> _itemProperties = new();
        ...
        private static readonly ObservableCollection<TileProperty> _tileProperties = new();
        private static readonly ObservableCollection<TileProperty> _tileBricks = new();
        ...
        private static Dictionary<int, string> _npcNames = new();
